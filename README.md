...
基于 **Spring Boot 3 + Vue 3** 前后端分离架构的养老机构综合管理平台。系统覆盖老人入住、床位分配、护理服务、餐饮管理、外出审批、退住管理等核心业务流程，内置 **RBAC 三级角色权限体系**（管理员 / 健康管家 / 老人），并集成 **AI 智能助手「小东」** 提供对话式运营咨询，帮助工作人员高效管理日常运营。
