<template>
  <div class="page-container">
    <el-card>
      ...
      <el-table :data="tableData" border stripe v-loading="loading" style="width:100%;margin-top:16px" table-layout="auto">
        ...
        <el-table-column prop="relativePhone" label="亲属手机号" min-width="130" />
        <el-table-column prop="nurseLevelName" label="护理等级" min-width="100" />
...
@media screen and (max-width: 768px) {
  /* In-dialog form — make el-row cols full width */
