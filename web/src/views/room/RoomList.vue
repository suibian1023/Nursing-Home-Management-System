  ...
  <div class="page-container">
    <el-card>
      ...
      <el-table :data="tableData" border stripe v-loading="loading" style="width:100%;margin-top:16px" table-layout="auto">
        ...
        <el-table-column prop="roomType" label="房型" min-width="100" />
        <el-table-column prop="floor" label="楼层" min-width="80" />
        <el-table-column prop="bedCount" label="床位总数" min-width="80" />
        <el-table-column prop="emptyBed" label="空床数" min-width="80" />
